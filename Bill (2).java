class Bill{
	...
	public Bill(int billRefId, int billSeqNo, String billIssDate, String DueDate, boolean isBillPd,
				boolean isBillLtst, boolean isFnlBill, boolean taxIncBill, double billAmount){
					
					billReferenceId = billRefId;
					billSequenceNo = billSeqNo;
					billIssueDate = billIssDate;
					billDueDate = DueDate;
					isBillPaid = isBillPd;
					isBillLatest = isBillLtst;
					isFinalBill = isFnlBill;
					taxInclusiveBill = taxIncBill;
					billAmt = billAmount;
				}
